...
export const ChatBubbleLeftRightIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.72.372a3.527 3.527 0 0 1-3.296-2.043l-1.255-.93a1.125 1.125 0 0 0-1.506 0l-1.255.93a3.527 3.527 0 0 1-3.296 2.043l-3.72.372C3.847 17.1 3 16.136 3 15v-4.286c0-.97.616-1.813 1.5-2.097m16.5 0a2.25 2.25 0 0 0-2.25-2.25H5.25A2.25 2.25 0 0 0 3 8.511m16.5 0-1.667-1.667M3 8.511 4.667 6.845" />
  </svg>
);
